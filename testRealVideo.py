...
from data.audioVisual_dataset import (generate_spectrogram_complex,
                                      get_preprocessing_pipelines, load_frame,
                                      load_mouthroi)
    ...
    for speaker_index in range(opt.number_of_speakers):
        ...
        if opt.reliable_face:
            ...
            for i in range(10):
                ...
                if scores[0] is not None and scores[0] > best_score:
                    best_frame = frame
