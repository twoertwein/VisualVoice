...
def load_args(default_config=None):
    ...
    parser.add_argument(
        "--save-direc", default=None, help="the directory of saving mouth ROIs"
    )
    # -- mean face utils
    parser.add_argument(
        "--mean-face",
        default="./utils/20words_mean_face.npy",
    ...
    parser.add_argument(
        "--convert-gray", default=False, action="store_true", help="convert2grayscale"
    )
    # -- test set only
    parser.add_argument(
        "--testset-only",
